...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/Cellar/bazel/3.3.1/bin/bazel',
    '/private/var/tmp/_bazel_polymitis/79ffd2e868a7e22f358a4a0226ba7717/execroot/mediapipe',
    'ios_arm64',
    {
        'tvos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/polymitis/Library/Application Support/Tulsi/0.20200624.88/Bazel',
