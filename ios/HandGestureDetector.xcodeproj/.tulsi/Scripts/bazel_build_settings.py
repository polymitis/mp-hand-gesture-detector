...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/polymitis/Projects/bazel-1.1.0/output/bazel',
    '/private/var/tmp/_bazel_polymitis/609b41128b185adc21e460c114e95cb1/execroot/mediapipe',
    'ios_arm64',
    {
        'ios_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/polymitis/Library/Application Support/Tulsi/0.20200219.88/Bazel',
