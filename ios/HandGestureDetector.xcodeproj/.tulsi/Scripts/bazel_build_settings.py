...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/polymitis/go/bin/bazelisk',
    '/private/var/tmp/_bazel_polymitis/eb14d4ba1c860320cb9071c6f057e089/execroot/mediapipe',
    '/private/var/tmp/_bazel_polymitis/eb14d4ba1c860320cb9071c6f057e089',
    'ios_arm64',
    {
        'ios_armv7': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/polymitis/Library/Application Support/Tulsi/0.20210318.88/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            ...
            build = [
                ...
                '--incompatible_objc_provider_remove_compile_info=false',
            ],
        ),
    ),
    {},
